...
const SAMPLE_PRODUCTS: Product[] = [
  {
    ...
    model3d: {
      obj: require('./assets/objects3D/IndoorPotPlant/indoor-plant_02.obj'),
      mtl: require('./assets/objects3D/IndoorPotPlant/indoor-plant_02.mtl'),
      texture: require('./assets/objects3D/IndoorPotPlant/textures/1024/indoor-plant_2_COL.jpg'),
    },
  },
  {
    id: '2',
    ...
    price: 15000,
    image: 'https://picsum.photos/200',
    model3d: require('./assets/objects3D/cottage_obj.obj'),
  },
];
  ...
  return (
    <ViroARScene onTrackingUpdated={onInitialized}>
      ...
      <ViroNode position={position} dragType="FixedToWorld">
        <Viro3DObject
          source={product.model3d.obj}
          resources={[
            product.model3d.mtl,
            product.model3d.texture
          ]}
          type="OBJ"
          position={[0, 0, 0]}
          scale={scale}
